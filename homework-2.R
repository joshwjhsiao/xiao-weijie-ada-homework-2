...
SE <- c(zombie.sp$height.se, zombie.sp$weight_se, zombie.sp$age_se, zombie.sp$zombies_killed_se, zombie.sp$years_of_education_se)
...
samp_CIs <- list("height_sample" = CI(zombie.sp$height_mean, zombie.sp$height_se),
